...
#p(ibmsecurity.isam.base.network.interfaces_ipv4.add(isamAppliance=isam9_server3, label='1.1', vlanId=None, address='192.168.24.104', maskOrPrefix='24'))
...
p(ibmsecurity.isam.web.reverse_proxy.instance.add(isam9_server3,inst_name=rp_name, admin_pwd= "passw0rd", host=host_name, ip_address=rp_ip, listening_port="7000", domain="Default"))
